...
Command: npx gltfjsx@6.5.3 basement-room.glb 
*/
...
export function BRoom(props) {
  const { nodes, materials } = useGLTF('/models/basement-room.glb')
  return (
    <group {...props} dispose={null}>
      <group position={[-2.367, -2.249, -1.226]} rotation={[-Math.PI / 2, 0, 0]} scale={0.754}>
...
useGLTF.preload('/models/basement-room.glb')
